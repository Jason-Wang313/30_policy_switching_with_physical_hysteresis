# Paper30 VLA Highlight Hardening Plan

Date: 2026-06-20

## Objective

Make `C:/Users/wangz/Downloads/30.pdf` match the visible VLA-v4 role model's PDF link-box behavior while preserving the final 25-page physical-hysteresis paper:

- internal table/figure references should render as red one-point boxes;
...
- Canonical PDF: `C:/Users/wangz/Downloads/30.pdf`
- Pages: 25
- Size: 550,057 bytes
- SHA256: `6B8D9A0050D0FCF81907884652B2D305ED6F62021C83FFF49BD0CE919459DD00`
...
- The manuscript contains two internal `\ref` commands: `tab:main` and `fig:pareto`.
...
4. Render the new link pages into `tmp/pdfs/paper30_after`.
5. Visually inspect every affected page:
   - red boxes appear around table/figure references and match the VLA role model's one-point outline style;
...
8. Remove Paper30 temp renders, leaving only the shared role-model render directory.
9. Stage only Paper30 source and metadata files, commit, push, and verify a clean repository.
...
- Final PDF: `C:/Users/wangz/Downloads/30.pdf`
- Pages: 25
- Size: 599,452 bytes
...
- Visual QA: link page rendered from the rebuilt Downloads PDF and inspected. Red boxes are crisp and aligned; no layout drift or cyan boxes appear. Green cite/url boxes are configured by policy but absent because the manuscript has no cite/url link annotations.
